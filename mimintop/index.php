  ...
  <body>
          ...
          <div class="navbar-header">
            <div class="d-flex">
              ...
              <div class="navbar-brand-box horizontal-logo">
                <a href="<?php echo $alamat_website_admin.'dasbor'; ?>" class="logo logo-dark">
                  <span class="logo-sm">
                ...
                <a href="<?php echo $alamat_website_admin.'dasbor'; ?>" class="logo logo-light">
                  <span class="logo-sm">
                    <img src="assets/images/<?php echo $isi1_logo_admin_sm; ?>" alt="Logo" height="22">
                  </span>
                  <span class="logo-lg">
        ...
        <div class="page-content">
          <div class="container-fluid">
            ...
            <?php
              ...
              } else if ($halaman_aktif == "slideshow") {
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                  Dikembangkan oleh : <a href="https://instagram.com/achkam16" target="_blank">Ichall</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <?php
          if (isset($_POST['filter_pengunjung'])) {
            ...
            if ($cek_pengunjung > 0) {
              echo '<script>window.location.replace("'.$alamat_website_admin.'dasbor/filter/'.$bulan_pengunjung.'/'.$tahun_pengunjung.'");</script>';
            } else {
    ?>
    <script>
      $(document).ready(function () {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.replace("<?php echo $alamat_website_admin; ?>dasbor");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.replace("<?php echo $alamat_website_admin; ?>anggota");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>deposit");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        ?>
        $("#selesaikan_<?php echo $id_withdraw; ?>").appendTo("body");
        $("#batalkan_<?php echo $id_withdraw; ?>").appendTo("body");
        $("#data_asal_<?php echo $id_withdraw; ?>").appendTo("body");
        $("#hapus_data_<?php echo $id_withdraw; ?>").appendTo("body");
        <?php
          }
        ?>
      });
    ...
    <?php
          if (isset($_POST['batalkan'])) {
            ...
            $id_akun_withdraw = $_POST['id_akun_withdraw'];
            $jumlah_withdraw = $_POST['jumlah_withdraw'];
            $status_withdraw = $_POST['status_withdraw'];
            $saldo = mysqli_query($koneksi, "SELECT * FROM saldo WHERE id_akun_saldo = '$id_akun_withdraw'");
            $data_saldo = mysqli_fetch_array($saldo);
            $total_saldo = $data_saldo['total_saldo'];
            $ubah_status_withdraw = mysqli_query($koneksi, "UPDATE withdraw SET status_withdraw = '$status_withdraw' WHERE id_withdraw = '$id_withdraw'");
            if ($ubah_status_withdraw) {
              $ubah_total_saldo = mysqli_query($koneksi, "UPDATE saldo SET total_saldo = '$total_saldo' WHERE id_akun_saldo = '$id_akun_withdraw'");
              if ($ubah_total_saldo) {
    ?>
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>withdraw");
          }
        });
      });
    </script>
    <?php
              ...
              echo "Proses Gagal<br>Error : ".$ubah_status_withdraw."<br>".mysqli_error($koneksi);
            }
          } else if (isset($_POST['selesaikan'])) {
            $id_withdraw = $_POST['id_withdraw'];
            $id_akun_withdraw = $_POST['id_akun_withdraw'];
            ...
            $saldo = mysqli_query($koneksi, "SELECT * FROM saldo WHERE id_akun_saldo = '$id_akun_withdraw'");
            $data_saldo = mysqli_fetch_array($saldo);
            $total_saldo = $data_saldo['total_saldo'] - $jumlah_withdraw;
            $ubah_status_withdraw = mysqli_query($koneksi, "UPDATE withdraw SET status_withdraw = '$status_withdraw' WHERE id_withdraw = '$id_withdraw'");
            if ($ubah_status_withdraw) {
              $ubah_total_saldo = mysqli_query($koneksi, "UPDATE saldo SET total_saldo = '$total_saldo' WHERE id_akun_saldo = '$id_akun_withdraw'");
              if ($ubah_total_saldo) {
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>games");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>promosi");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        <?php
          $slideshow = mysqli_query($koneksi, "SELECT * FROM slideshow");
          while ($data_slideshow = mysqli_fetch_array($slideshow)) {
            $id_slideshow = $data_slideshow['id_slideshow'];
        ?>
        $("#ubah_data_<?php echo $id_slideshow; ?>").appendTo("body");
        $("#hapus_data_<?php echo $id_slideshow; ?>").appendTo("body");
        <?php
          }
        ?>
      });
    ...
    <?php
          if (isset($_POST['tambah_data'])) {
            ...
            $random = rand(1000000000, 9999999999);
            $tmp_file = $_FILES['gambar_slideshow']['tmp_name'];
            $nama_file = $_FILES['gambar_slideshow']['name'];
            $format =  array('png', 'PNG', 'jpg', 'JPG', 'jpeg', 'JPEG', 'gif', 'GIF');
            $extensi = pathinfo($nama_file, PATHINFO_EXTENSION);
            if (!in_array($extensi, $format)) {
    ?>
    ...
    <?php
              ...
              $file = strtolower(str_replace(" ", "_", $nama_file));
              $file_input = $random.'_'.$file;
              $lokasi_simpan = "assets/images/slideshow/".$file_input;
              if (move_uploaded_file($tmp_file, $lokasi_simpan)) {
                $tambah_data = mysqli_query($koneksi, "INSERT INTO slideshow (gambar_slideshow, judul_slideshow) VALUES ('$file_input', '$judul_slideshow')");
                if ($tambah_data) {
    ?>
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>slideshow");
          }
        });
      });
    </script>
    ...
    <?php
                ...
                $lokasi_simpan = "assets/images/slideshow/".$file_input;
                if (move_uploaded_file($tmp_file, $lokasi_simpan)) {
                  $ubah_data = mysqli_query($koneksi, "UPDATE slideshow SET gambar_slideshow = '$file_input', judul_slideshow = '$judul_slideshow' WHERE id_slideshow = '$id_slideshow'");
                  if ($ubah_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <?php
              ...
              $ubah_data = mysqli_query($koneksi, "UPDATE slideshow SET judul_slideshow = '$judul_slideshow' WHERE id_slideshow = '$id_slideshow'");
              if ($ubah_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <?php
            ...
            $id_slideshow = $_POST['id_slideshow'];
            $hapus_data = mysqli_query($koneksi, "DELETE FROM slideshow WHERE id_slideshow = '$id_slideshow'");
            if ($hapus_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>bank");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>rekening");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>rekening_admin");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.replace("<?php echo $alamat_website_admin; ?>rekening_anggota");
          }
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.replace("<?php echo $alamat_website_admin; ?>profil");
          }
        });
      });
    </script>
