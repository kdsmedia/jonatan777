          ...
          <div class="card card-animate">
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  <?php
                 $deposit = mysqli_query($koneksi, "SELECT SUM(jumlah_deposit) AS total_deposit FROM deposit WHERE status_deposit='selesai'");
                  ...
                  <a href="<?php echo $alamat_website_admin.'deposit'; ?>" class="text-decoration-underline">Lihat detail data</a>
                </div>
...
<div class="card card-animate">
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  <?php
                    $withdraw = mysqli_query($koneksi, "SELECT SUM(jumlah_withdraw) AS total_withdraw FROM withdraw WHERE status_withdraw='selesai'");
                    $data_withdraw = mysqli_fetch_array($withdraw);
                    $total_withdraw = $data_withdraw['total_withdraw'];
                  ?>
                  <h4 class="fs-22 fw-semibold ff-secondary mb-4">Rp. <span class="counter-value" data-target="<?php echo $total_withdraw; ?>">0</span>,-</h4>
                  <a href="<?php echo $alamat_website_admin.'withdraw'; ?>" class="text-decoration-underline">Lihat detail data</a>
                </div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded fs-3">
                    <i class="ri-money-dollar-circle-fill text-primary"></i>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  ...
                  <a href="<?php echo $alamat_website_admin.'anggota'; ?>" class="text-decoration-underline">Lihat detail data</a>
                </div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded fs-3">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  ...
                  <a href="<?php echo $alamat_website_admin.'games'; ?>" class="text-decoration-underline">Lihat detail data</a>
                </div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded fs-3">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  ...
                  <a href="<?php echo $alamat_website_admin.'promosi'; ?>" class="text-decoration-underline">Lihat detail data</a>
                </div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded fs-3">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                  ...
                  <a href="<?php echo $alamat_website_admin.'pengunjung'; ?>" class="text-decoration-underline" style="visibility: hidden;">Lihat detail data</a>
                </div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary rounded fs-3">
                    <i class="ri-fire-fill text-primary"></i>
