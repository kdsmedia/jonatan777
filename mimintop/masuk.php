<?php
  ...
  if (isset($_SESSION['id_akun'])) {
    echo '
      <script>
        window.location.replace("'.$alamat_website_admin.'");
      </script>
    ';
    ...
    if ($cek_akun > 0) {
      ...
      echo '
        <script>
          ...
          window.location.replace("'.$alamat_website_admin.'masuk");
        </script>
      ';
    }
  }
            ...
            <div class="col-lg-12">
              <div class="text-center">
                <p class="mb-0 text-muted">
                  <?php echo date("Y"); ?> &copy; <a href="<?php echo $alamat_website; ?>"><?php echo $isi1_judul_website; ?></a>
                </p>
              </div>
            </div>
          </div>
