<?php
  ...
  if (!isset($_GET['halaman'])) {
    ...
    // Pengecekan apakah ada data saldo untuk akun masuk
    $saldo_query = mysqli_query($koneksi, "SELECT * FROM saldo WHERE id_akun_saldo = '$id_akun_masuk'");
    if ($saldo_query) {
      $data_saldo = mysqli_fetch_array($saldo_query);
      if ($data_saldo) {
        $id_saldo = $data_saldo['id_saldo'];
        $total_saldo = $data_saldo['total_saldo'];
      } else {
        // Jika tidak ada data saldo, inisialisasi variabel $id_saldo dan $total_saldo
        $id_saldo = null;
        $total_saldo = 0;
      }
    } else {
      // Jika query untuk mengambil saldo gagal, inisialisasi variabel $id_saldo dan $total_saldo
      $id_saldo = null;
      $total_saldo = 0;
    }
    ...
    if ($jumlah_nama_pengguna > 0) {
      ...
      if ($input_kode_verifikasi != $kode_verifikasi) {
        ...
        $daftar = mysqli_query($koneksi, "INSERT INTO akun (nama_lengkap_akun, nama_pengguna_akun, kata_sandi_akun, email_akun, telepon_akun, kode_referensi_akun) VALUES ('$nama_lengkap_akun', '$nama_pengguna_akun', '$kata_sandi_akun', '$email_akun', '$telepon_akun', '$kode_referensi_akun')");
        if ($daftar) {
  ...
  <div class="fixed-top">
    <div class="container-fluid bg-king position-relative p-3">
      <a href="<?php echo $alamat_website.'beranda'; ?>" class="d-block">
        <img src="<?php echo $alamat_website_admin; ?>assets/images/<?php echo $isi1_logo; ?>" alt="Logo" height="50" class="float-left mr-3">
      </a>
          ...
          <a href="<?php echo $alamat_website.'beranda'; ?>" class="d-flex flex-column align-items-center text-decoration-none">
            <?php
              if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "beranda") {
                  echo '
                    <img src="./assets/images/beranda/home-active.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Beranda</span>
                  ';
                } else {
                  echo '
                    <img src="./assets/images/beranda/home.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Beranda</span>
                  ';
                }
              } else {
            ...
            <?php
              if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "deposit" || $_GET['halaman'] == "penarikan" || $_GET['halaman'] == "rekening" || $_GET['halaman'] == "riwayat_deposit" || $_GET['halaman'] == "riwayat_withdraw") {
                  echo '
                    <img src="./assets/images/beranda/banking-active.svg" alt="Banking" width="25" height="25">
                    <span class="text-utama">Banking</span>
                  ';
                } else {
                  echo '
                    <img src="./assets/images/beranda/banking.svg" alt="Banking" width="25" height="25">
                    <span class="text-utama">Banking</span>
                  ';
                }
              } else {
            ...
            <?php
              if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "masuk") {
                  echo '
                    <img src="./assets/images/beranda/login-active.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Masuk</span>
                  ';
                } else {
                  echo '
                    <img src="./assets/images/beranda/login.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Masuk</span>
                  ';
                }
              } else {
            ...
            <?php
              if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "promosi") {
                  echo '
                    <img src="./assets/images/beranda/promotion-active.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Promosi</span>
                  ';
                } else {
                  echo '
                    <img src="./assets/images/beranda/promotion.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Promosi</span>
                  ';
                }
              } else {
            ...
            <?php
              if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "hub_kami") {
                  echo '
                    <img src="./assets/images/beranda/live-chat-active.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Hub Kami</span>
                  ';
                } else {
                  echo '
                    <img src="./assets/images/beranda/live-chat.svg" alt="Home" width="25" height="25">
                    <span class="text-utama">Hub Kami</span>
                  ';
                }
              } else {
