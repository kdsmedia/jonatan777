...
if (empty($_SESSION['id_akun'])) {
  $keluar = 1;
  if ($keluar == 1) { // Perhatikan penggunaan == (perbandingan) daripada =
    echo '<script>
    window.history.go(-2);
  </script>
  ';
...
<form method="post">
  ...
  <div class="row gy-2 gx-0 d-flex justify-content-center align-items-center mt-5">
    ...
    <div class="col-10">
      <div class="bg-dark rounded p-2">
        ...
        <option>-- Pilih Promo --</option>
            ...
            <option>DEPOSIT 500 BONUS 3JT</option>
        </select>
      </div>
    </div>
    ...
    <div class="col-10">
      <div class="bg-dark rounded p-2">
        <span class="d-block mb-2" style="font-size: 14px;">DEPOSIT MENGGUNAKAN KODE UNIK, CONTOH (50.878)</span>
