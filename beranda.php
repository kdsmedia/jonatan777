    ...
    <div class="d-flex">
      ...
      <div class="d-flex flex-grow-1 overflow-auto m-0" id="scroll-kategori">
        ...
        if (isset($_SESSION['id_akun'])) {
            ...
            echo '<a href="'.$alamat_website.'daftar" class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3 ms-auto">';
        }
        ?>
        <img src="./assets/images/beranda/hot-games.svg" alt="Hot Games" class="d-block my-svg my-2 mx-auto" width="25" height="25">
        Hot Games
    </a>
    <?php
    if (isset($_SESSION['id_akun'])) {
        ...
        echo '<a href="'.$alamat_website.'daftar" class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">';
    }
    ?>
    <img src="./assets/images/beranda/slots.svg" alt="Slots" class="d-block my-2 my-svg mx-auto" width="25" height="25">
    Slots
</a>
<?php
if (isset($_SESSION['id_akun'])) {
...
?>
<img src="./assets/images/beranda/casino.svg" alt="Casino" class="d-block my-2 mx-auto" width="25" height="25">
Live Casino
</a>
<?php
if (isset($_SESSION['id_akun'])) {
...
?>
<img src="./assets/images/beranda/sports.svg" alt="Sports" class="d-block my-2 mx-auto" width="25" height="25">
Sports
</a>
<?php
if (isset($_SESSION['id_akun'])) {
...
?>
<img src="./assets/images/beranda/arcade.svg" alt="Arcade" class="d-block my-2 mx-auto" width="25" height="25">
Arcade
</a>
<?php
if (isset($_SESSION['id_akun'])) {
...
?>
<img src="./assets/images/beranda/poker.svg" alt="Poker" class="d-block my-2 mx-auto" width="25" height="25">
Poker
</a>
<?php
if (isset($_SESSION['id_akun'])) {
    ...
    echo '<a href="'.$alamat_website.'daftar" class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3 me-auto">';
}
?>
<img src="./assets/images/beranda/others.svg" alt="Togel" class="d-block my-2 mx-auto" width="25" height="25">
Togel
</a>
</div>
...
<style>
    ...
    <div class="popular-game-title-container">
        <div class="title">
            <i data-icon="popular-games" style="--image-src: url(./assets/images/beranda/popular-games.png?v=20230823-2);"></i>
            Game Populer
        </div>
        ...
        <ul>
            <li class="game_item" data-game="Gates of Olympus™">
                <label class="inner-game-item">
                    ...
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/vs20olympgate.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/vs20olympgate.jpg?v=20230823-2" type="image/jpeg" /><img alt="Gates of Olympus™" loading="lazy" src="./assets/images/beranda/vs20olympgate.jpg?v=20230823-2" /></picture>
            ...
            <li class="game_item" data-game="Mahjong Ways 2">
                <label class="inner-game-item">
                    <input type="radio" name="game-list-radio-button" />
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/mahjong-ways2.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/mahjong-ways2.jpg?v=20230823-2" type="image/jpeg" /><img alt="Mahjong Ways 2" loading="lazy" src="./assets/images/beranda/mahjong-ways2.jpg?v=20230823-2" /></picture>
                        <span class="link-container">
            ...
            <li class="game_item" data-game="Lucky Twins Nexus">
                <label class="inner-game-item">
                    <input type="radio" name="game-list-radio-button" />
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/SMG_luckyTwinsNexus.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/SMG_luckyTwinsNexus.jpg?v=20230823-2" type="image/jpeg" /><img alt="Lucky Twins Nexus" loading="lazy" src="./assets/images/beranda/SMG_luckyTwinsNexus.jpg?v=20230823-2" /></picture>
                        <span class="link-container">
            ...
            <li class="game_item" data-game="Aztec: Bonus Hunt">
                <label class="inner-game-item">
                    <input type="radio" name="game-list-radio-button" />
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/AdvantPlay_10022.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/AdvantPlay_10022.jpg?v=20230823-2" type="image/jpeg" /><img alt="Aztec: Bonus Hunt" loading="lazy" src="./assets/images/beranda/AdvantPlay_10022.jpg?v=20230823-2" /></picture>
                        <span class="link-container">
            ...
            <li class="game_item" data-game="Hot Hot Fruit">
                <label class="inner-game-item">
                    <input type="radio" name="game-list-radio-button" />
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/SGHotHotFruit.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/SGHotHotFruit.jpg?v=20230823-2" type="image/jpeg" /><img alt="Hot Hot Fruit" loading="lazy" src="./assets/images/beranda/SGHotHotFruit.jpg?v=20230823-2" /></picture>
                        <span class="link-container">
            ...
            <li class="game_item" data-game="Money Tree Slot">
                <label class="inner-game-item">
                    <input type="radio" name="game-list-radio-button" />
                    <span class="wrapper-container">
                        <picture><source srcset="./assets/images/beranda/MoneyTree.webp?v=20230823-2" type="image/webp" /><source srcset="./assets/images/beranda/MoneyTree.jpg?v=20230823-2" type="image/jpeg" /><img alt="Money Tree Slot" loading="lazy" src="./assets/images/beranda/MoneyTree.jpg?v=20230823-2" /></picture>
                        <span class="link-container">
    ...
    <div class="popular-game-title-container">
        <div class="title">
            <i data-icon="popular-games" style="--image-src: url(./assets/images/beranda/download-app.png?v=20230823-2);"></i>
            UNDUH
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="apk_install_guide_modal_body">
                            <h5><img loading="lazy" src="./assets/images/beranda/android-logo.svg?v=20230823-2"> Instalasi Android</h5>
                            <ol>
                                <li>
