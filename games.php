...
// Periksa apakah session 'id_akun' ada
if (isset($_SESSION['id_akun'])) {
    // Ambil id_akun dari session
    $id_akun = $_SESSION['id_akun'];

    // Query untuk mengambil saldo berdasarkan id_akun
    $query = "SELECT total_saldo FROM saldo WHERE id_akun_saldo = $id_akun";
    ...
    <div class="col-12">
        <div class="d-flex">
            ...
            <div class="d-flex flex-grow-1 overflow-auto m-0" id="scroll-kategori">
                <a href="<?php echo $alamat_website . 'games/kategori/slots'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3 ms-auto">
                    <img src="../../assets/images/beranda/hot-games.svg" alt="Hot Games"
                         class="d-block my-2 mx-auto" width="25" height="25">
                    Hot Games
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/slots'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">
                    <?php
                    if ($link_menu_games_aktif == "slots") {
                        echo '<img src="../../assets/images/beranda/slots-active.svg" alt="Slots" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/slots.svg" alt="Slots" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Slots
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/live_casino'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">
                    <?php
                    if ($link_menu_games_aktif == "live_casino") {
                        echo '<img src="../../assets/images/beranda/casino-active.svg" alt="Casino" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/casino.svg" alt="Casino" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Live Casino
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/sports'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">
                    <?php
                    if ($link_menu_games_aktif == "sports") {
                        echo '<img src="../../assets/images/beranda/sports-active.svg" alt="Sports" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/sports.svg" alt="Sports" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Sports
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/arcade'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">
                    <?php
                    if ($link_menu_games_aktif == "arcade") {
                        echo '<img src="../../assets/images/beranda/arcade-active.svg" alt="Arcade" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/arcade.svg" alt="Arcade" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Arcade
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/poker'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3">
                    <?php
                    if ($link_menu_games_aktif == "poker") {
                        echo '<img src="../../assets/images/beranda/poker-active.svg" alt="Poker" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/poker.svg" alt="Poker" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Poker
                </a>
                <a href="<?php echo $alamat_website . 'games/kategori/togel'; ?>"
                   class="d-block text-nowrap text-utama text-decoration-none text-center text-uppercase p-3 me-auto">
                    <?php
                    if ($link_menu_games_aktif == "togel") {
                        echo '<img src="../../assets/images/beranda/others-active.svg" alt="Togel" class="d-block my-2 mx-auto" width="25" height="25">';
                    } else {
                        echo '<img src="../../assets/images/beranda/others.svg" alt="Togel" class="d-block my-2 mx-auto" width="25" height="25">';
                    }
                    ?>
                    Togel
                </a>
    ...
    if (isset($_GET['link_menu_games'])) {
        if (isset($_GET['link_sub_menu_games'])) {
            ...
            if (isset($_GET['link_games'])) {
                ...
                $link_to_redirect = !empty($link_asli_games) ? $link_asli_games : $link_demo_games;
                
                if (!empty($link_to_redirect)) {
                    // Redirect langsung ke tautan yang sesuai
                    echo '
                    <script>
                    ...
                    // Jika kedua tautan kosong, lakukan sesuatu yang sesuai, misalnya menampilkan pesan.
                    echo '
                    <div class="col-12 p-1">
                        <iframe src="' . $link_demo_games . '" style="border:none;" name="20olympgate" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="550px" width="100%" allowfullscreen=""></iframe>
                    </div>
                    ';
                }
            } else {
                ...
                while ($data_games = mysqli_fetch_array($games)) {
                    ...
                    $link_asli_games = $data_games['link_asli_games'];
                    $link_demo_games = $data_games['link_demo_games'];
        if (!empty($link_asli_games) || !empty($link_demo_games)) {
                      echo '<div class="col-4 p-1">';
if (!empty($link_asli_games) ) {
  if (empty($link_asli_games) || !stristr($link_asli_games, 'https://')) {
    $link_to_redirect = $link_demo_games;
} else {
    $link_to_redirect = $link_asli_games;
}

    echo '
    <a href="' . $link_to_redirect . '">
        <img src="' . $alamat_website_admin . '/assets/images/games/' . $gambar_games . '" alt="' . $nama_games . '" class="d-block w-100 mb-2">
        <span class="d-block text-center" style="font-size: 14px;">' . $nama_games . '</span>
    </a>
    ';
} else {
    echo '<span class="d-block text-center" style="font-size: 20px;">Game Belum Tersedia</span>';
}
echo '</div>';
          ...
          while ($data_sub_menu_games = mysqli_fetch_array($sub_menu_games)) {
              ...
              if ($link_menu_games_aktif == "slots" && $link_sub_menu_games == "pragmatic_play") {
                  $link_to_redirect = $alamat_website . 'games/kategori/' . $link_menu_games_aktif . '/' . $link_sub_menu_games;
              } else {
                  $link_to_redirect = '#' . $link_sub_menu_games;
              }
              echo '
              <div class="col-4 p-1">
                  <a href="' . ($total_saldo == 0 ? $alamat_website . 'deposit' : $link_to_redirect) . '">
                      <img src="' . $alamat_website_admin . 'assets/images/' . $link_menu_games_aktif . '/' . $gambar_sub_menu_games . '" alt="' . $judul_sub_menu_games . '" class="d-block w-100 mb-2">
                      <span class="d-block text-center" style="font-size: 14px;">' . $judul_sub_menu_games . '</span>
                  </a>
              </div>';
              if ($link_menu_games_aktif != "slots") {
                  echo '
                  <div class="modal fade" id="' . $link_sub_menu_games . '" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-hidden="true">
